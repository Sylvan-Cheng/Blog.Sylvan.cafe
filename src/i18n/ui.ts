...
export const UI = {
  ...
  social: {
    ...
    shareWhatsApp: {
      ...
      de: "Diesen Beitrag via WhatsApp teilen",
    } satisfies Dict,
    shareFacebook: {
      zh: "分享到 Facebook",
      ...
      de: "Diesen Beitrag auf Facebook teilen",
    } satisfies Dict,
    shareX: {
      zh: "分享到 X",
      ...
      ja: "X で共有",
      ru: "Поделиться в X",
      de: "Diesen Beitrag auf X teilen",
    } satisfies Dict,
    shareTelegram: {
      zh: "通过 Telegram 分享",
      ...
      de: "Diesen Beitrag via Telegram teilen",
    } satisfies Dict,
    sharePinterest: {
      zh: "分享到 Pinterest",
      ...
      de: "Diesen Beitrag auf Pinterest teilen",
    } satisfies Dict,
    shareEmail: {
      zh: "通过邮件分享",
      ...
      de: "Diesen Beitrag per E-Mail teilen",
    } satisfies Dict,
  },
};
